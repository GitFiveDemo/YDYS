...
public class HomessAdapter extends RecyclerView.Adapter<HomessAdapter.ViewHolder> {
    private Context context;
    private List<HomeBean.RetBean.ListBean.ChildListBean> list;

    public HomessAdapter(Context context, List<HomeBean.RetBean.ListBean.ChildListBean> list) {
    ...
    @NonNull
    @Override
    public HomessAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.first_messs_item, null);
        ViewHolder holder = new ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull HomessAdapter.ViewHolder holder, final int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imageview = itemView.findViewById(R.id.imageviewss);
            movie_name = itemView.findViewById(R.id.movie_namess);
